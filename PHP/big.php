<?php
  ...
  $servername = "localhost";
	...
	$conn->query($query);
  $query = "SELECT projectname FROM projectdetails WHERE domain = 'bd'";
...
<div class='login'>
    		<div class='login_title'>
    			<span><img src='https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/user_icon_copy.png'>&nbsp&nbspProject List &nbsp</span>
    	  	</div>
